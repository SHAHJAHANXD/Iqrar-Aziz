...
<li><p class="mb-5" data-aos="fade-right" data-aos-delay="100">Other attack Detection capabilities, such as recognition of invalid or malformed packets, IP defragmentation, and TCP reassembly.</li></p></ul>
              <!-- <img src="{{url('public/assets/img/phone_1.png')}}" alt="Image" class="phone-1" data-aos="fade-right">
              <img src="{{url('public/assets/img/phone_2.png')}}" alt="Image" class="phone-2" data-aos="fade-right" data-aos-delay="200"> -->
            </div>
          </div>
        </div>
      </div>
